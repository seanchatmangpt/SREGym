...
HERE=pathlib.Path(__file__).resolve().parent; SUBJECT=json.loads((HERE/'subject.json').read_text()); CASES=json.loads((HERE/'cases.json').read_text()); HEX40=re.compile(r'^[0-9a-f]{40}$'); EXPECTED='seanchatmangpt/SREGym'
def classify(s):
